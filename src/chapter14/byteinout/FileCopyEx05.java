...
public class FileCopyEx05 {
	...
	public static void main(String[] args) {
		...
		createTestFile(sourceFilePath, 1024 * 1024 * 10); // 10M 데이터 생성
		...
		System.out.println("버퍼없이 복사 소요 시간 : " + durationWithoutBuffer / 1_000_000 + "ms");

		// 버퍼를 사용하여 파일 복사
		startTime = System.nanoTime(); // 복사 시작
		copyWithBuffer(sourceFilePath, destFilePathWithBuffer); // 복사중
	...
	// 원본 파일 생성(createTestFile)메서드 구현
